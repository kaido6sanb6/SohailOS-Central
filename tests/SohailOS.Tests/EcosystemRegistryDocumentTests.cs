...
public class EcosystemRegistryDocumentTests
{
    ...
    public void Manifest_DeclaresExpectedTopLevelContract()
    {
        ...
        Assert.True(repositories.GetArrayLength() >= 47);
        ...
        Assert.Equal(repositories.GetArrayLength(), sync.GetProperty("live_repository_count").GetInt32());
    }
    ...
    public void Manifest_HasUniqueRepositories_AndIntegritySafeEdgesAndRoutes()
    {
        ...
        Assert.Equal(root.GetProperty("repositories").GetArrayLength(), ids.Count);
