#!/usr/bin/env python3
"""Build the fork-only inventory used by the continuous fork synchronization layer."""
...
for repo in repos:
    ...
    # The owner-list response normally includes parent/source. If it does not,
    # resolve the repository explicitly rather than guessing provenance.
...
forks.sort(key=lambda item: (item["full_name"] or "").lower())
